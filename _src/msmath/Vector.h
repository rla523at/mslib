...
template <typename T>
concept input_iterator_or_int = std::input_iterator<T> || std::same_as<T, int>;
...
public:
  ...
  template <std::input_iterator T, input_iterator_or_int U>
...
public:
  Vector(void) { this->reallocate_values(); };
  Vector(const Vector& other)
      : _coordinates{other._coordinates} { this->reallocate_values(); };
