...
TEST(Matrix_Wrapper, column_vector_wrapper_1)
{
  ...
  auto           column_vector = m.column_wrapper(column_index);
...
TEST(Matrix_Wrapper, change_values_1)
{
  ...
  Matrix_Const_Wrapper m2 = {num_rows2, num_columns2, vals2.data(), leading_dimension2, Transpose_Type::not_transposed};
  // m2 =	¦¢ 1  2  3 ¦¢
  //			¦¢ 6  7  8 ¦¢
...
TEST(Matrix_Wrapper, change_values_2)
{
  ...
  Matrix_Const_Wrapper m2 = {num_rows2, num_columns2, vals2.data(), leading_dimension, Transpose_Type::transposed};
  // m =	¦¢ 1  2  3  4  ¦¢T	 =	¦¢	1 6 11 ¦¢
  //			¦¢ 6  7  8  9  ¦¢				¦¢	2 7 12 ¦¢
  //			¦¢ 11 12 13 14	¦¢				¦¢ 3	8 13 ¦¢
  //														¦¢ 4 9 14 ¦¢
...
TEST(Matrix_Wrapper, row_vector_wrapper_1)
{
  ...
  auto           row_vector = m.row_wrapper(row_index);
