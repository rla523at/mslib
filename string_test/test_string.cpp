...
{
  constexpr auto str = "REFERENCE FILE : D:/AutoTestingSystem/01_MecTester/MecSolver_Latest/Reference/18_mskim/JouleHeating/ElementTest/DependentMaterial/Quad4X_NTJH.out";

  const auto result = ms::string::remove_before(str, "D:/");
  constexpr auto ref ="D:/AutoTestingSystem/01_MecTester/MecSolver_Latest/Reference/18_mskim/JouleHeating/ElementTest/DependentMaterial/Quad4X_NTJH.out";
  EXPECT_EQ(result, ref);
}

TEST(string, remove_up_to)
{
  constexpr auto str = "REFERENCE FILE : D:/AutoTestingSystem/01_MecTester/MecSolver_Latest/Reference/18_mskim/JouleHeating/ElementTest/DependentMaterial/Quad4X_NTJH.out";

  const auto     result = ms::string::remove_up_to(str, "/Reference/");
  constexpr auto ref    = "18_mskim/JouleHeating/ElementTest/DependentMaterial/Quad4X_NTJH.out";
  EXPECT_EQ(result, ref);
}
